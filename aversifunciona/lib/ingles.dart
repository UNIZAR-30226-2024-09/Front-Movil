...
class ingles extends StatefulWidget {
  @override
  _ingles_State createState() => _ingles_State();
}

class _ingles_State extends State<ingles> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Row(
          children: [
            Text('Buscar ingles', style: TextStyle(color: Colors.white)),
          ],
        ),
        backgroundColor: Colors.black,
