...
class relax extends StatefulWidget {
  @override
  _relax_State createState() => _relax_State();
}

class _relax_State extends State<relax> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Row(
          children: [
            Text('Buscar relax', style: TextStyle(color: Colors.white)),
          ],
        ),
        backgroundColor: Colors.black,
