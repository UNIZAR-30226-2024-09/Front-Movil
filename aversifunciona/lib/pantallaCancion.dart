              ...
              children: [
                ...
                IconButton(
                  onPressed: () async{
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Reproductor(cancion: cancion, ids: [cancion.id!], playlist: 'Reproduciendo canción',)), // cancion: cancion dentro de reproductor cuando esto funcione
                    );
                  },
